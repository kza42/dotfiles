...
--
myWorkspaces = [" main ", " www ", " sys ", " 4 ", " 5 ", " 6 ", " 7 ", " 8 ", " chat "]
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm,               xK_Escape ), spawn ("echo \"" ++ help ++ "\" | xmessage -file -"))
    ]
    ++
...
myLayout =
  ...
  where
    myDefaultLayout = tall ||| full ||| wide
...
myStartupHook = do
   ...
   spawnOnce "sleep 2 && trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 --height 44 --tint 0x282c34"
